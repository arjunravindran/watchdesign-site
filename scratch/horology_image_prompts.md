# Horology Image Prompts Directory
...
## Module 01: Anatomy & History of Horology
...
- **DALL-E 3 Prompt:**
  ```text
  A high-detail macro studio photograph of an authentic 18th-century Breguet pocket watch. The silver dial features hand-engraved guilloche patterns and elegant roman numerals with classic blued steel open-tipped hands. The watch casing is slightly open, showing golden hand-finished gears and escapement. Dark dramatic background, highlighting the historical craftsmanship.
  ```
...
### m01-s05: External Components
- **Target Filename:** `m01_s05_external_components.png`
- **Recommended Approach:** **🟢 KEEP EXISTING LOCAL ASSET**
...
- **Current Local Image:** `/images/m01/anatomy.png`
...
- **DALL-E 3 Prompt:**
  ```text
  A curated luxury watch brand strategy moodboard. It features physical elements: a swatch of dark brown alligator leather, a sample of brushed gold metal, a deep blue ceramic card, and minimalist editorial typography cards showing branding keywords. Laid out flat on a clean textured stone background.
  ```
...
### m01-s11: The Escapement
- **Target Filename:** `m01_s11_the_escapement.png`
- **Recommended Approach:** **🟢 KEEP EXISTING LOCAL ASSET**
- *Reason:* This slide is an informative technical schematic or graphic pre-designed for this curriculum. No AI generation needed.
- **Current Local Image:** `/images/m01/escapement.png`
...
### m01-s14: 1700 – 1850  —  The Age of Precision
- **Target Filename:** `m01_s14_1700_1850_the_age_of_precision.png`
- **Recommended Approach:** **🟢 KEEP EXISTING LOCAL ASSET**
- *Reason:* This slide is an informative technical schematic or graphic pre-designed for this curriculum. No AI generation needed.
- **Current Local Image:** `/images/m01/history.png`
...
## Module 02: Brand Strategy & Market Landscape
...
## Module 03: Mechanical Movements & Engineering
...
## Module 04: Concept Sketching & Ideation

### m04-s01: MODULE 04
- **Target Filename:** `m04_s01_module_04.png`
...
### m04-s04: The Ideation Process
- **Target Filename:** `m04_s04_the_ideation_process.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m04-s07: The Connection — Strap & Bracelet Sketching
- **Target Filename:** `m04_s07_the_connection_strap_bracelet_sketching.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m04-s09: Concept Sketching
- **Target Filename:** `m04_s09_concept_sketching.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m04-s10: Designing for the Wrist — Ergonomics
- **Target Filename:** `m04_s10_designing_for_the_wrist_ergonomics.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
## Module 05: 2D Rendering & Technical Drawing

### m05-s01: MODULE 05
- **Target Filename:** `m05_s01_module_05.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m05-s02: Illustrator Foundations — Required
- **Target Filename:** `m05_s02_illustrator_foundations_required.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m05-s03: The Five Tools You Actually Need
- **Target Filename:** `m05_s03_the_five_tools_you_actually_need.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m05-s04: Building a Watch Case in Vector
- **Target Filename:** `m05_s04_building_a_watch_case_in_vector.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
...
- **DALL-E 3 Prompt:**
  ```text
  An orthographic technical drawing of a luxury wristwatch. The design is displayed as a clean vector graphic, showing front and profile views with precise line work, dimension indicators, and subtle flat shading. The background is a professional dark slate color, evoking high-end CAD blueprints.
  ```
...
### m05-s08: 2D Rendering &
- **Target Filename:** `m05_s08_2d_rendering.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
## Module 06: 3D CAD Modelling

### m06-s01: MODULE 06
- **Target Filename:** `m06_s01_module_06.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* Orthographic vector line drawings and dimensions are extremely abstract. DALL-E 3 is highly capable of generating clean, flat 2D blueprint aesthetics and crisp industrial design illustrations without typical photographic noise.
- **Web Search Query:** `2D vector watch design orthographic blueprint`
- **Midjourney v6 Prompt:**
...
### m06-s03: Fusion 360 for Watch Designers
- **Target Filename:** `m06_s03_fusion_360_for_watch_designers.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m06-s08: 3D CAD
- **Target Filename:** `m06_s08_3d_cad.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
...
- **DALL-E 3 Prompt:**
  ```text
  A clean screenshot of a high-end watch case 3D solid model in a CAD application. The model is rendered in polished titanium with precise surface chamfers and bevels. A subtle blue wireframe grid overlays the model to show the geometric mesh. The workstation UI is modern and dark-themed.
  ```



## Module 07: Materials, Finishes & Manufacturing
...
- **DALL-E 3 Prompt:**
  ```text
  A high-detail macro photograph of the titanium case lug of a luxury watch. It showcases the contrast between a perfectly brushed top surface and an mirror-polished, sharp beveled edge (Zaratsu finish), reflecting a soft studio softbox light. The texture of the metal is highly defined.
  ```
...
### m07-s05: Luminous Materials & Colour Harmony
- **Target Filename:** `m07_s05_luminous_materials_colour_harmony.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m07-s07: Crystal Types & Anti-Reflective Coatings
- **Target Filename:** `m07_s07_crystal_types_anti_reflective_coatings.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* Orthographic vector line drawings and dimensions are extremely abstract. DALL-E 3 is highly capable of generating clean, flat 2D blueprint aesthetics and crisp industrial design illustrations without typical photographic noise.
- **Web Search Query:** `2D vector watch design orthographic blueprint`
- **Midjourney v6 Prompt:**
...
### m07-s09: Materials, Finishes
- **Target Filename:** `m07_s09_materials_finishes.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* Orthographic vector line drawings and dimensions are extremely abstract. DALL-E 3 is highly capable of generating clean, flat 2D blueprint aesthetics and crisp industrial design illustrations without typical photographic noise.
- **Web Search Query:** `2D vector watch design orthographic blueprint`
- **Midjourney v6 Prompt:**
...
## Module 08: Rendering & Visualisation

### m08-s01: MODULE 08
- **Target Filename:** `m08_s01_module_08.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* Orthographic vector line drawings and dimensions are extremely abstract. DALL-E 3 is highly capable of generating clean, flat 2D blueprint aesthetics and crisp industrial design illustrations without typical photographic noise.
- **Web Search Query:** `2D vector watch design orthographic blueprint`
- **Midjourney v6 Prompt:**
...
### m08-s02: Understanding Light on Metal
- **Target Filename:** `m08_s02_understanding_light_on_metal.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* Orthographic vector line drawings and dimensions are extremely abstract. DALL-E 3 is highly capable of generating clean, flat 2D blueprint aesthetics and crisp industrial design illustrations without typical photographic noise.
- **Web Search Query:** `2D vector watch design orthographic blueprint`
- **Midjourney v6 Prompt:**
...
### m08-s03: KeyShot Workflow for Watches
- **Target Filename:** `m08_s03_keyshot_workflow_for_watches.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* This slide focuses on 3D computer modeling. DALL-E 3 is recommended as it excels at generating structured software UI screenshots and precise CAD metallic wireframes, looking exactly like a modern designer's monitor.
- **Web Search Query:** `3D CAD model of watch case in Fusion 360 screenshot`
- **Midjourney v6 Prompt:**
...
### m08-s05: Rendering &
- **Target Filename:** `m08_s05_rendering.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* Orthographic vector line drawings and dimensions are extremely abstract. DALL-E 3 is highly capable of generating clean, flat 2D blueprint aesthetics and crisp industrial design illustrations without typical photographic noise.
- **Web Search Query:** `2D vector watch design orthographic blueprint`
- **Midjourney v6 Prompt:**
...
## Module 09: Trends, Portfolio & Career
...
- **DALL-E 3 Prompt:**
  ```text
  A premium mockup of a watch designer's printed portfolio book. The book is open to a page showing a photorealistic render of a modern dive watch alongside an orthographic spec sheet. It lies on a clean minimalist concrete table with long shadows from a large window.
  ```

### m09-s02: Current Design Trends & Macro Forces
- **Target Filename:** `m09_s02_current_design_trends_macro_forces.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
### m09-s03: Building Your Portfolio Presentation
- **Target Filename:** `m09_s03_building_your_portfolio_presentation.png`
- **Recommended Approach:** **🎨 DALL-E 3 GENERATED (Recommended)**
- *Reason:* For case sketching and design ideation, DALL-E 3 handles drawing elements, sketch textures, grid lines, and mock-technical annotations with much higher semantic consistency, perfectly matching the design studio theme.
- **Web Search Query:** `industrial watch design sketches on desk with pencil`
- **Midjourney v6 Prompt:**
...
## Module 10: Advanced & Specialist Topics
...
- **DALL-E 3 Prompt:**
  ```text
  A professional horological studio shot of a luxury watch, focused on showing the "MODULE 10" concept in detail. The background is a clean textured slate surface under soft, moody directional studio lighting.
  ```
